...
Self-hosted OPDS servers like [Komga](https://komga.org) are excellent, and
Longbox exists because a comics server built in Rust, shipped as one installable
web app, is a different set of trade-offs worth making. The goals:
