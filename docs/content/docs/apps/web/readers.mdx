...
Longbox has a few different built-in readers that you can use to read your books. Each reader is designed to be used with a specific type of book, and they all have their own unique features.
