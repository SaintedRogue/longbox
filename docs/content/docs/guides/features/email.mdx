...
Longbox has basic email functionality built-in, allowing you to send books via email. This feature was primarily developed to support email-to-ereader integrations, however there are loose plans for expanding it in the future.
...
<Callout>
	The password field is encrypted at rest and not visible after creation. Longbox will decrypt the
	password when sending emails. This is a security measure to prevent unauthorized access to your
	email server. You should still take care to secure your Longbox instance.
</Callout>
