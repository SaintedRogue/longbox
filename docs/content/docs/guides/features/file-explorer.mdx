...
Certain entities throughout Longbox have a file explorer scoped to them, allowing you to traverse the files and directories within that entity. The entities that have a file explorer are:
