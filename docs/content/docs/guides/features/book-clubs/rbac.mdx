...
Who gets into a book club — and who gets to run one — comes down to a couple of house rules on your server. There are two relevant user permissions that affect access to the book club feature as a whole:
