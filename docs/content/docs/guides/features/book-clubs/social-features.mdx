...
While Longbox is notably **not** a chat application, I will try to make these as functional as possible while still keeping the scope reasonable. Some features that I think would be nice to have:
