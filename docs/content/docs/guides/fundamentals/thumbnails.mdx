...
Longbox uses thumbnails to display images of your media throughout the app. By default, Longbox will pull the first image from a media file to use as a thumbnail. However, you can customize this behavior per-library by configuring the thumbnail generation settings
