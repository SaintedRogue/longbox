...
Longbox shows a cover for every book so you can browse your shelf at a glance. By default, Longbox will pull the first image from a media file to use as a thumbnail. However, you can customize this behavior per-library by configuring the thumbnail generation settings
...
### » Image Candidacy (how the thumbnail source is picked)
