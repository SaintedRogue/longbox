...
<Callout type="warn">
    Access to libraries today is effectively an opt-out model. Longbox will be moving to an opt-in model in the future, but for now users will have access to all libraries by default. You can follow [this issue](https://github.com/stumpapp/stump/issues/1151) to track the progress of this change.
</Callout>
