...
/// Returns the value of the `LONGBOX_CONFIG_DIR` environment variable if it is set,
/// logs an error and returns `~/.longbox` otherwise.
...
///   1. The `LONGBOX_IN_DOCKER` environment variable.
