...
// TODO(koreader): healthcheck? I don't think it is required, since I could configure Longbox as a
...
struct GetProgressResponse {
	...
	/// identifying a book, since koreader is unaware of the book's ID in longbox
	document: String,
	...
	/// The ID of the koreader device, generated by koreader. Longbox will use this to identify a
...
/// cannot be parsed, it is assumed to be an x-pointer. Longbox does not support x-pointers, so
