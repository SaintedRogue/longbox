...
const documents: Documents = {
    ...
    "\n\tquery MediaExternalMetadata($provider: MetadataProvider!, $externalId: String!) {\n\t\tmediaExternalMetadata(provider: $provider, externalId: $externalId) {\n\t\t\ttitle\n\t\t\tsummary\n\t\t\tpageCount\n\t\t\tseriesName\n\t\t\tseriesExternalId\n\t\t\tnumber\n\t\t\tnumberRaw\n\t\t\tday\n\t\t\tmonth\n\t\t\tyear\n\t\t\tgenres\n\t\t\ttags\n\t\t\tisbn\n\t\t\tisbn13\n\t\t\twriters\n\t\t\tartists\n\t\t\tcolorists\n\t\t\tletterers\n\t\t\tcoverArtists\n\t\t\tpencillers\n\t\t\tinkers\n\t\t\teditors\n\t\t\tcharacters\n\t\t\tteams\n\t\t\tstoryArc\n\t\t\timprint\n\t\t\tpublisher\n\t\t\tcoverUrl\n\t\t\tproviderUrl\n\t\t}\n\t}\n": types.MediaExternalMetadataDocument,
    "\n\tquery SeriesExternalMetadata($provider: MetadataProvider!, $externalId: String!) {\n\t\tseriesExternalMetadata(provider: $provider, externalId: $externalId) {\n\t\t\ttitle\n\t\t\tsummary\n\t\t\tstatus\n\t\t\tyear\n\t\t\tendYear\n\t\t\tgenres\n\t\t\ttags\n\t\t\tageRating\n\t\t\tauthors\n\t\t\tartists\n\t\t\tpublisher\n\t\t\tcoverUrl\n\t\t\tvolumeCount\n\t\t}\n\t}\n": types.SeriesExternalMetadataDocument,
    "\n\tquery MediaEnrichmentPool($id: ID!) {\n\t\tmediaEnrichmentPool(id: $id) {\n\t\t\tsources {\n\t\t\t\tprovider\n\t\t\t\texternalId\n\t\t\t\tproviderUrl\n\t\t\t\tstate\n\t\t\t\tchosenBy\n\t\t\t\tconfidence\n\t\t\t\tpayload\n\t\t\t}\n\t\t\tfieldSources {\n\t\t\t\tfield\n\t\t\t\tsourceProvider\n\t\t\t\tchosenBy\n\t\t\t}\n\t\t}\n\t}\n": types.MediaEnrichmentPoolDocument,
    "\n\tquery SeriesEnrichmentPool($id: ID!) {\n\t\tseriesEnrichmentPool(id: $id) {\n\t\t\tsources {\n\t\t\t\tprovider\n\t\t\t\texternalId\n\t\t\t\tproviderUrl\n\t\t\t\tstate\n\t\t\t\tchosenBy\n\t\t\t\tconfidence\n\t\t\t}\n\t\t\tfieldSources {\n\t\t\t\tfield\n\t\t\t\tsourceProvider\n\t\t\t\tchosenBy\n\t\t\t}\n\t\t}\n\t}\n": types.SeriesEnrichmentPoolDocument,
    ...
    "\n\tquery ProviderMatchRecord($id: MetadataFetchRecordId!) {\n\t\tmetadataFetchRecord(id: $id) {\n\t\t\t...PendingMatchRecord\n\t\t}\n\t}\n": types.ProviderMatchRecordDocument,
    ...
    "\n\tfragment SeriesGridCard on Series {\n\t\tid\n\t\tresolvedName\n\t\tmediaCount\n\t\tpercentageCompleted\n\t\tstatus\n\t\t# We fetch 2 and skip 1 because the first thumbnail _might_ be the same as the series thumbnail.\n\t\t# See https://github.com/stumpapp/stump/issues/899\n\t\tmedia(take: 2, skip: 1) {\n\t\t\tid\n\t\t\tthumbnail {\n\t\t\t\turl\n\t\t\t\tmetadata {\n\t\t\t\t\taverageColor\n\t\t\t\t\tcolors {\n\t\t\t\t\t\tcolor\n\t\t\t\t\t\tpercentage\n\t\t\t\t\t}\n\t\t\t\t\tthumbhash\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t\tthumbnail {\n\t\t\turl\n\t\t\tmetadata {\n\t\t\t\taverageColor\n\t\t\t\tcolors {\n\t\t\t\t\tcolor\n\t\t\t\t\tpercentage\n\t\t\t\t}\n\t\t\t\tthumbhash\n\t\t\t}\n\t\t}\n\t\tlibrary {\n\t\t\tid\n\t\t\tname\n\t\t}\n\t}\n": types.SeriesGridCardFragmentDoc,
    ...
    "\n\tquery ReconcileActiveJobs {\n\t\tjobs(pagination: { none: { unpaginated: true } }, statuses: [RUNNING, QUEUED, PAUSED]) {\n\t\t\tnodes {\n\t\t\t\tid\n\t\t\t\tstatus\n\t\t\t}\n\t\t}\n\t}\n": types.ReconcileActiveJobsDocument,
    "\n\tsubscription UseCoreEvent {\n\t\treadEvents {\n\t\t\t__typename\n\t\t\t... on CreatedManySeries {\n\t\t\t\tcount\n\t\t\t\tlibraryId\n\t\t\t}\n\t\t\t... on CreatedMedia {\n\t\t\t\tid\n\t\t\t\tseriesId\n\t\t\t}\n\t\t\t... on CreatedOrUpdatedManyMedia {\n\t\t\t\tcount\n\t\t\t\tseriesId\n\t\t\t}\n\t\t\t... on DiscoveredMissingLibrary {\n\t\t\t\tid\n\t\t\t}\n\t\t\t... on JobStarted {\n\t\t\t\tid\n\t\t\t}\n\t\t\t... on JobUpdate {\n\t\t\t\t__typename\n\t\t\t\tid\n\t\t\t\tstatus\n\t\t\t\tmessage\n\t\t\t\tcompletedTasks\n\t\t\t\tremainingTasks\n\t\t\t\tcompletedSubtasks\n\t\t\t\ttotalSubtasks\n\t\t\t\tsubtitle\n\t\t\t}\n\t\t\t... on JobOutput {\n\t\t\t\tid\n\t\t\t\toutput {\n\t\t\t\t\t__typename\n\t\t\t\t\t... on LibraryScanOutput {\n\t\t\t\t\t\tcreatedMedia\n\t\t\t\t\t\tcreatedSeries\n\t\t\t\t\t\tupdatedMedia\n\t\t\t\t\t\tupdatedSeries\n\t\t\t\t\t}\n\t\t\t\t\t... on SeriesScanOutput {\n\t\t\t\t\t\tcreatedMedia\n\t\t\t\t\t\tupdatedMedia\n\t\t\t\t\t}\n\t\t\t\t\t... on OrganizeLooseFilesOutput {\n\t\t\t\t\t\tmoved\n\t\t\t\t\t\tproposedMoves\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n": types.UseCoreEventDocument,
    "\n\tmutation UseFollowSeries($id: ID!, $isFollowing: Boolean!) {\n\t\tfollowSeries(id: $id, isFollowing: $isFollowing)\n\t}\n": types.UseFollowSeriesDocument,
    ...
    "\n\tquery ReleaseCalendarMonth($monthOffset: Int!, $scope: CalendarScope!) {\n\t\treleaseCalendarMonth(monthOffset: $monthOffset, scope: $scope) {\n\t\t\tmonthStart\n\t\t\tlabel\n\t\t\tdays {\n\t\t\t\tdate\n\t\t\t\tentries {\n\t\t\t\t\tseriesId\n\t\t\t\t\tseriesName\n\t\t\t\t\tnumber\n\t\t\t\t\ttitle\n\t\t\t\t\tcoverUrl\n\t\t\t\t\tinLibrary\n\t\t\t\t\tisFollowed\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n": types.ReleaseCalendarMonthDocument,
    "\n\tquery ReleaseCalendar($weekOffset: Int!, $scope: CalendarScope!) {\n\t\treleaseCalendar(weekOffset: $weekOffset, scope: $scope) {\n\t\t\tdate\n\t\t\tentries {\n\t\t\t\tseriesId\n\t\t\t\tseriesName\n\t\t\t\tnumber\n\t\t\t\ttitle\n\t\t\t\tcoverUrl\n\t\t\t\tinLibrary\n\t\t\t\tisFollowed\n\t\t\t}\n\t\t}\n\t}\n": types.ReleaseCalendarDocument,
    "\n\tquery UpcomingReleases($scope: CalendarScope!) {\n\t\tupcomingReleases(scope: $scope) {\n\t\t\tdate\n\t\t\tentries {\n\t\t\t\tseriesId\n\t\t\t\tseriesName\n\t\t\t\tnumber\n\t\t\t\ttitle\n\t\t\t\tcoverUrl\n\t\t\t\tinLibrary\n\t\t\t\tisFollowed\n\t\t\t}\n\t\t}\n\t}\n": types.UpcomingReleasesDocument,
    "\n\tquery CalendarSyncStatus {\n\t\treleaseCalendarStatus {\n\t\t\tisRunning\n\t\t\tlastSyncedAt\n\t\t\tisScheduled\n\t\t}\n\t}\n": types.CalendarSyncStatusDocument,
    "\n\tmutation CalendarSyncStatusSync {\n\t\tsyncReleaseCalendar {\n\t\t\tisRunning\n\t\t\tlastSyncedAt\n\t\t}\n\t}\n": types.CalendarSyncStatusSyncDocument,
    ...
    "\n\tquery LibraryCollectionScene($id: ID!) {\n\t\tbookGroupById(id: $id) {\n\t\t\tid\n\t\t\tname\n\t\t\tsource\n\t\t\tbookCount\n\t\t\tbooks {\n\t\t\t\tid\n\t\t\t\t...BookCard\n\t\t\t}\n\t\t}\n\t}\n": types.LibraryCollectionSceneDocument,
    "\n\tquery LibraryCollections($libraryId: ID!) {\n\t\tbookGroups(libraryId: $libraryId) {\n\t\t\tid\n\t\t\tname\n\t\t\tbookCount\n\t\t\tbooks {\n\t\t\t\tid\n\t\t\t\tthumbnail {\n\t\t\t\t\turl\n\t\t\t\t\tmetadata {\n\t\t\t\t\t\taverageColor\n\t\t\t\t\t\tcolors {\n\t\t\t\t\t\t\tcolor\n\t\t\t\t\t\t\tpercentage\n\t\t\t\t\t\t}\n\t\t\t\t\t\tthumbhash\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n": types.LibraryCollectionsDocument,
    "\n\tmutation LibraryCollectionsDetect($libraryId: ID!) {\n\t\tdetectBookGroups(libraryId: $libraryId) {\n\t\t\tgroupsCreated\n\t\t\tgroupsMatched\n\t\t\tgroupsPruned\n\t\t\tbooksGrouped\n\t\t\tbooksStandalone\n\t\t}\n\t}\n": types.LibraryCollectionsDetectDocument,
    ...
    "\n\tquery OrganizeSearchSeries(\n\t\t$libraryId: ID!\n\t\t$title: String!\n\t\t$year: Int\n\t\t$provider: MetadataProvider\n\t) {\n\t\torganizeSearchSeries(libraryId: $libraryId, title: $title, year: $year, provider: $provider) {\n\t\t\tprovider\n\t\t\texternalId\n\t\t\tconfidence\n\t\t\tmetadata {\n\t\t\t\t__typename\n\t\t\t\t... on ExternalSeriesMetadata {\n\t\t\t\t\ttitle\n\t\t\t\t\tyear\n\t\t\t\t\tpublisher\n\t\t\t\t\tauthors\n\t\t\t\t\tcoverUrl\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n": types.OrganizeSearchSeriesDocument,
    "\n\tquery OrganizeSeriesMatchProviders {\n\t\tmetadataProviderConfigs {\n\t\t\tproviderType\n\t\t\tenabled\n\t\t\tposition\n\t\t}\n\t}\n": types.OrganizeSeriesMatchProvidersDocument,
    "\n\tquery OrganizePreviewForPath($libraryId: ID!, $path: String!) {\n\t\torganizePreviewForPath(libraryId: $libraryId, path: $path) {\n\t\t\tproposedMoves {\n\t\t\t\tsrc\n\t\t\t\tdst\n\t\t\t\tcanonicalName\n\t\t\t\tyear\n\t\t\t\texternalId\n\t\t\t\tprovider\n\t\t\t\tconfidence\n\t\t\t\tbucket\n\t\t\t\texistingSeriesId\n\t\t\t}\n\t\t\tunmatched {\n\t\t\t\tsrc\n\t\t\t\tparsedSeries\n\t\t\t\treason\n\t\t\t}\n\t\t}\n\t}\n": types.OrganizePreviewForPathDocument,
    "\n\tmutation ScopedOrganizeApply($libraryId: ID!, $decisions: [OrganizeDecisionInput!]!) {\n\t\tapplyOrganizeLooseFiles(libraryId: $libraryId, decisions: $decisions)\n\t}\n": types.ScopedOrganizeApplyDocument,
    ...
    "\n\tquery LibrarySearchScene($search: String, $pagination: Pagination!) {\n\t\tlibraries(search: $search, pagination: $pagination) {\n\t\t\tnodes {\n\t\t\t\tid\n\t\t\t\t...LibraryCard\n\t\t\t}\n\t\t\tpageInfo {\n\t\t\t\t__typename\n\t\t\t\t... on OffsetPaginationInfo {\n\t\t\t\t\tcurrentPage\n\t\t\t\t\ttotalPages\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n": types.LibrarySearchSceneDocument,
    ...
    "\n\tquery SeriesSearchAlphabet {\n\t\tseriesAlphabet\n\t}\n": types.SeriesSearchAlphabetDocument,
    "\n\tquery SeriesSearchScene(\n\t\t$filter: SeriesFilterInput!\n\t\t$search: String\n\t\t$orderBy: [SeriesOrderBy!]!\n\t\t$pagination: Pagination!\n\t) {\n\t\tseries(filter: $filter, search: $search, orderBy: $orderBy, pagination: $pagination) {\n\t\t\tnodes {\n\t\t\t\tid\n\t\t\t\t# Selected flat as well as via the fragment: fragment masking hides these\n\t\t\t\t# from the query result, and the table view reads them directly.\n\t\t\t\tresolvedName\n\t\t\t\tmediaCount\n\t\t\t\tpercentageCompleted\n\t\t\t\tstatus\n\t\t\t\t...SeriesGridCard\n\t\t\t}\n\t\t\tpageInfo {\n\t\t\t\t__typename\n\t\t\t\t... on OffsetPaginationInfo {\n\t\t\t\t\ttotalPages\n\t\t\t\t\tcurrentPage\n\t\t\t\t\tpageSize\n\t\t\t\t\tpageOffset\n\t\t\t\t\tzeroBased\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n": types.SeriesSearchSceneDocument,
    ...
    "\n\tmutation ToggleProviderEnabled($id: Int!, $enabled: Boolean!) {\n\t\tupdateMetadataProvider(id: $id, input: { enabled: $enabled }) {\n\t\t\tid\n\t\t\tenabled\n\t\t}\n\t}\n": types.ToggleProviderEnabledDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tfragment LibraryCard on Library {\n\t\tid\n\t\tname\n\t\temoji\n\t\tstats {\n\t\t\tseriesCount\n\t\t\tbookCount\n\t\t}\n\t}\n"): typeof import('./graphql').LibraryCardFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery MediaExternalMetadata($provider: MetadataProvider!, $externalId: String!) {\n\t\tmediaExternalMetadata(provider: $provider, externalId: $externalId) {\n\t\t\ttitle\n\t\t\tsummary\n\t\t\tpageCount\n\t\t\tseriesName\n\t\t\tseriesExternalId\n\t\t\tnumber\n\t\t\tnumberRaw\n\t\t\tday\n\t\t\tmonth\n\t\t\tyear\n\t\t\tgenres\n\t\t\ttags\n\t\t\tisbn\n\t\t\tisbn13\n\t\t\twriters\n\t\t\tartists\n\t\t\tcolorists\n\t\t\tletterers\n\t\t\tcoverArtists\n\t\t\tpencillers\n\t\t\tinkers\n\t\t\teditors\n\t\t\tcharacters\n\t\t\tteams\n\t\t\tstoryArc\n\t\t\timprint\n\t\t\tpublisher\n\t\t\tcoverUrl\n\t\t\tproviderUrl\n\t\t}\n\t}\n"): typeof import('./graphql').MediaExternalMetadataDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery SeriesExternalMetadata($provider: MetadataProvider!, $externalId: String!) {\n\t\tseriesExternalMetadata(provider: $provider, externalId: $externalId) {\n\t\t\ttitle\n\t\t\tsummary\n\t\t\tstatus\n\t\t\tyear\n\t\t\tendYear\n\t\t\tgenres\n\t\t\ttags\n\t\t\tageRating\n\t\t\tauthors\n\t\t\tartists\n\t\t\tpublisher\n\t\t\tcoverUrl\n\t\t\tvolumeCount\n\t\t}\n\t}\n"): typeof import('./graphql').SeriesExternalMetadataDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery MediaEnrichmentPool($id: ID!) {\n\t\tmediaEnrichmentPool(id: $id) {\n\t\t\tsources {\n\t\t\t\tprovider\n\t\t\t\texternalId\n\t\t\t\tproviderUrl\n\t\t\t\tstate\n\t\t\t\tchosenBy\n\t\t\t\tconfidence\n\t\t\t\tpayload\n\t\t\t}\n\t\t\tfieldSources {\n\t\t\t\tfield\n\t\t\t\tsourceProvider\n\t\t\t\tchosenBy\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').MediaEnrichmentPoolDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery SeriesEnrichmentPool($id: ID!) {\n\t\tseriesEnrichmentPool(id: $id) {\n\t\t\tsources {\n\t\t\t\tprovider\n\t\t\t\texternalId\n\t\t\t\tproviderUrl\n\t\t\t\tstate\n\t\t\t\tchosenBy\n\t\t\t\tconfidence\n\t\t\t}\n\t\t\tfieldSources {\n\t\t\t\tfield\n\t\t\t\tsourceProvider\n\t\t\t\tchosenBy\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').SeriesEnrichmentPoolDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery ProviderMatchRecord($id: MetadataFetchRecordId!) {\n\t\tmetadataFetchRecord(id: $id) {\n\t\t\t...PendingMatchRecord\n\t\t}\n\t}\n"): typeof import('./graphql').ProviderMatchRecordDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tfragment SeriesGridCard on Series {\n\t\tid\n\t\tresolvedName\n\t\tmediaCount\n\t\tpercentageCompleted\n\t\tstatus\n\t\t# We fetch 2 and skip 1 because the first thumbnail _might_ be the same as the series thumbnail.\n\t\t# See https://github.com/stumpapp/stump/issues/899\n\t\tmedia(take: 2, skip: 1) {\n\t\t\tid\n\t\t\tthumbnail {\n\t\t\t\turl\n\t\t\t\tmetadata {\n\t\t\t\t\taverageColor\n\t\t\t\t\tcolors {\n\t\t\t\t\t\tcolor\n\t\t\t\t\t\tpercentage\n\t\t\t\t\t}\n\t\t\t\t\tthumbhash\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t\tthumbnail {\n\t\t\turl\n\t\t\tmetadata {\n\t\t\t\taverageColor\n\t\t\t\tcolors {\n\t\t\t\t\tcolor\n\t\t\t\t\tpercentage\n\t\t\t\t}\n\t\t\t\tthumbhash\n\t\t\t}\n\t\t}\n\t\tlibrary {\n\t\t\tid\n\t\t\tname\n\t\t}\n\t}\n"): typeof import('./graphql').SeriesGridCardFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery ReconcileActiveJobs {\n\t\tjobs(pagination: { none: { unpaginated: true } }, statuses: [RUNNING, QUEUED, PAUSED]) {\n\t\t\tnodes {\n\t\t\t\tid\n\t\t\t\tstatus\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').ReconcileActiveJobsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tmutation UseFollowSeries($id: ID!, $isFollowing: Boolean!) {\n\t\tfollowSeries(id: $id, isFollowing: $isFollowing)\n\t}\n"): typeof import('./graphql').UseFollowSeriesDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery ReleaseCalendarMonth($monthOffset: Int!, $scope: CalendarScope!) {\n\t\treleaseCalendarMonth(monthOffset: $monthOffset, scope: $scope) {\n\t\t\tmonthStart\n\t\t\tlabel\n\t\t\tdays {\n\t\t\t\tdate\n\t\t\t\tentries {\n\t\t\t\t\tseriesId\n\t\t\t\t\tseriesName\n\t\t\t\t\tnumber\n\t\t\t\t\ttitle\n\t\t\t\t\tcoverUrl\n\t\t\t\t\tinLibrary\n\t\t\t\t\tisFollowed\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').ReleaseCalendarMonthDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery UpcomingReleases($scope: CalendarScope!) {\n\t\tupcomingReleases(scope: $scope) {\n\t\t\tdate\n\t\t\tentries {\n\t\t\t\tseriesId\n\t\t\t\tseriesName\n\t\t\t\tnumber\n\t\t\t\ttitle\n\t\t\t\tcoverUrl\n\t\t\t\tinLibrary\n\t\t\t\tisFollowed\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').UpcomingReleasesDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery CalendarSyncStatus {\n\t\treleaseCalendarStatus {\n\t\t\tisRunning\n\t\t\tlastSyncedAt\n\t\t\tisScheduled\n\t\t}\n\t}\n"): typeof import('./graphql').CalendarSyncStatusDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tmutation CalendarSyncStatusSync {\n\t\tsyncReleaseCalendar {\n\t\t\tisRunning\n\t\t\tlastSyncedAt\n\t\t}\n\t}\n"): typeof import('./graphql').CalendarSyncStatusSyncDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery CharacterDetailScene($name: String!) {\n\t\tcharacterByName(name: $name) {\n\t\t\tname\n\t\t\tbookCount\n\t\t\tbooks {\n\t\t\t\tid\n\t\t\t\t...BookCard\n\t\t\t\t...BookMetadata\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').CharacterDetailSceneDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery CharactersScene($search: String, $orderBy: [CharacterOrderBy!]!, $pagination: Pagination!) {\n\t\tcharacters(search: $search, orderBy: $orderBy, pagination: $pagination) {\n\t\t\tnodes {\n\t\t\t\tname\n\t\t\t\t...CharacterCard\n\t\t\t}\n\t\t\tpageInfo {\n\t\t\t\t__typename\n\t\t\t\t... on OffsetPaginationInfo {\n\t\t\t\t\tcurrentPage\n\t\t\t\t\ttotalPages\n\t\t\t\t\tpageSize\n\t\t\t\t\tpageOffset\n\t\t\t\t\tzeroBased\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').CharactersSceneDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery LibraryCollectionScene($id: ID!) {\n\t\tbookGroupById(id: $id) {\n\t\t\tid\n\t\t\tname\n\t\t\tsource\n\t\t\tbookCount\n\t\t\tbooks {\n\t\t\t\tid\n\t\t\t\t...BookCard\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').LibraryCollectionSceneDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery LibraryCollections($libraryId: ID!) {\n\t\tbookGroups(libraryId: $libraryId) {\n\t\t\tid\n\t\t\tname\n\t\t\tbookCount\n\t\t\tbooks {\n\t\t\t\tid\n\t\t\t\tthumbnail {\n\t\t\t\t\turl\n\t\t\t\t\tmetadata {\n\t\t\t\t\t\taverageColor\n\t\t\t\t\t\tcolors {\n\t\t\t\t\t\t\tcolor\n\t\t\t\t\t\t\tpercentage\n\t\t\t\t\t\t}\n\t\t\t\t\t\tthumbhash\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').LibraryCollectionsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tmutation LibraryCollectionsDetect($libraryId: ID!) {\n\t\tdetectBookGroups(libraryId: $libraryId) {\n\t\t\tgroupsCreated\n\t\t\tgroupsMatched\n\t\t\tgroupsPruned\n\t\t\tbooksGrouped\n\t\t\tbooksStandalone\n\t\t}\n\t}\n"): typeof import('./graphql').LibraryCollectionsDetectDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery OrganizeSearchSeries(\n\t\t$libraryId: ID!\n\t\t$title: String!\n\t\t$year: Int\n\t\t$provider: MetadataProvider\n\t) {\n\t\torganizeSearchSeries(libraryId: $libraryId, title: $title, year: $year, provider: $provider) {\n\t\t\tprovider\n\t\t\texternalId\n\t\t\tconfidence\n\t\t\tmetadata {\n\t\t\t\t__typename\n\t\t\t\t... on ExternalSeriesMetadata {\n\t\t\t\t\ttitle\n\t\t\t\t\tyear\n\t\t\t\t\tpublisher\n\t\t\t\t\tauthors\n\t\t\t\t\tcoverUrl\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').OrganizeSearchSeriesDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery OrganizeSeriesMatchProviders {\n\t\tmetadataProviderConfigs {\n\t\t\tproviderType\n\t\t\tenabled\n\t\t\tposition\n\t\t}\n\t}\n"): typeof import('./graphql').OrganizeSeriesMatchProvidersDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery OrganizePreviewForPath($libraryId: ID!, $path: String!) {\n\t\torganizePreviewForPath(libraryId: $libraryId, path: $path) {\n\t\t\tproposedMoves {\n\t\t\t\tsrc\n\t\t\t\tdst\n\t\t\t\tcanonicalName\n\t\t\t\tyear\n\t\t\t\texternalId\n\t\t\t\tprovider\n\t\t\t\tconfidence\n\t\t\t\tbucket\n\t\t\t\texistingSeriesId\n\t\t\t}\n\t\t\tunmatched {\n\t\t\t\tsrc\n\t\t\t\tparsedSeries\n\t\t\t\treason\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').OrganizePreviewForPathDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tmutation ScopedOrganizeApply($libraryId: ID!, $decisions: [OrganizeDecisionInput!]!) {\n\t\tapplyOrganizeLooseFiles(libraryId: $libraryId, decisions: $decisions)\n\t}\n"): typeof import('./graphql').ScopedOrganizeApplyDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery LibrarySearchScene($search: String, $pagination: Pagination!) {\n\t\tlibraries(search: $search, pagination: $pagination) {\n\t\t\tnodes {\n\t\t\t\tid\n\t\t\t\t...LibraryCard\n\t\t\t}\n\t\t\tpageInfo {\n\t\t\t\t__typename\n\t\t\t\t... on OffsetPaginationInfo {\n\t\t\t\t\tcurrentPage\n\t\t\t\t\ttotalPages\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').LibrarySearchSceneDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery SeriesSearchAlphabet {\n\t\tseriesAlphabet\n\t}\n"): typeof import('./graphql').SeriesSearchAlphabetDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery SeriesSearchScene(\n\t\t$filter: SeriesFilterInput!\n\t\t$search: String\n\t\t$orderBy: [SeriesOrderBy!]!\n\t\t$pagination: Pagination!\n\t) {\n\t\tseries(filter: $filter, search: $search, orderBy: $orderBy, pagination: $pagination) {\n\t\t\tnodes {\n\t\t\t\tid\n\t\t\t\t# Selected flat as well as via the fragment: fragment masking hides these\n\t\t\t\t# from the query result, and the table view reads them directly.\n\t\t\t\tresolvedName\n\t\t\t\tmediaCount\n\t\t\t\tpercentageCompleted\n\t\t\t\tstatus\n\t\t\t\t...SeriesGridCard\n\t\t\t}\n\t\t\tpageInfo {\n\t\t\t\t__typename\n\t\t\t\t... on OffsetPaginationInfo {\n\t\t\t\t\ttotalPages\n\t\t\t\t\tcurrentPage\n\t\t\t\t\tpageSize\n\t\t\t\t\tpageOffset\n\t\t\t\t\tzeroBased\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').SeriesSearchSceneDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tmutation ToggleProviderEnabled($id: Int!, $enabled: Boolean!) {\n\t\tupdateMetadataProvider(id: $id, input: { enabled: $enabled }) {\n\t\t\tid\n\t\t\tenabled\n\t\t}\n\t}\n"): typeof import('./graphql').ToggleProviderEnabledDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
