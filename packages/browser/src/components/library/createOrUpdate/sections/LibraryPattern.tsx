import { Heading, Link, RadioGroup, Text } from '@longbox/components'
import { LibraryPattern } from '@longbox/graphql'
			...
			<div className="gap-y-4 flex flex-col">
				...
				{isCreating && (
					<Text size="xs" variant="muted">
						...
						<Link
							target="_blank"
							href="https://github.com/SaintedRogue/longbox/blob/main/docs/content/docs/guides/fundamentals/libraries.mdx#supported-patterns"
						>
